...
// ============================================================
// WIKIVENDAS BUILD v6.0.4-WKGS (MARKDOWN COMPLETO, SEM POLUIÇÃO)
// ============================================================
...
// ============================================================
// EXTRACT TEMPLATE DATA (APENAS PARA O HERO)
// ============================================================
...
function extractTemplateData(record) {
  ...
  return {
    ...
    oQueE, oQueNaoE, perguntas, mitigacoes, fontesTecnicas: fontes,
    ...
    wikisales, metadadosTexto: metadados, provenienciaTexto: provenance
  };
}
...
function buildDesignSystemMeta({ title, description, canonical }) {
  ...
  <style>
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Estilos GitHub README para Markdown (SEM RISCOS AMARELOS) */
    .wv-markdown {
...
// ============================================================
// RENDER - TERMO (APENAS MARKDOWN, SEM POLUIÇÃO)
// ============================================================
...
async function build() {
  try {
    ...
    for (const record of records) {
      const data = extractTemplateData(record);
      const mdHtml = marked.parse(record.md || "");
